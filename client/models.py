...
class Dataset(models.Model):
    ...
    copiedemails = models.EmailField(null=True,blank=True)
    copiedemail1 = models.EmailField(null=True,blank=True)
    copiedemails2 = models.EmailField(null=True,blank=True)
    copiedemails3 = models.EmailField(null=True,blank=True)
